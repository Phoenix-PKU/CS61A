...
def tail_points(opponent_score):
    ...
    second_rightmost = (opponent_score // 10) % 10
...
def play(strategy0, strategy1, update,
    ...
    while 1:
        if who == 0:
            dice_to_roll0 = strategy0(score0,score1)
            score0 = update(dice_to_roll0, score0, score1, dice)
            if score0 >= goal:
                return score0, score1
            who = 1 - who
        else:
            dice_to_roll1 = strategy1(score1,score0)
            score1 = update(dice_to_roll1, score1, score0, dice)
            if score1 >= goal:
                return score0, score1
            who = 1 - who
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(100):
        for oppo_score in range(100):
            if num != strategy(score,oppo_score):
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    max_average_score, nums = 0, 0
    for nums_of_dice in range(1, 11):
        average_val_func = make_averaged(roll_dice, total_samples)
        average_val = average_val_func(nums_of_dice, dice)
        if average_val > max_average_score:
            max_average_score = average_val
            nums = nums_of_dice
    return nums
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    first check if I can win by rolling 0, 1 dice,
    then check if I can roll 0 to get more points,
    else return 6
    """
    # BEGIN PROBLEM 12
    ...
    # average point I can get rolling 6
    if square_strategy(0, score, opponent_score) - score >= threshold:
        return 0
